...
class CadRecodeDataset(Dataset):
    ...
    def get_img(self, item):
        ...
        return input_item
    # def get_img(self, item):
    #     mesh_rel_path = item['mesh_path']
    #     mesh_abs_path = os.path.abspath(os.path.join(self.root_dir, mesh_rel_path))
    #     stem = os.path.splitext(mesh_abs_path)[0]
    #     img_path = stem + '_render.png'

    #     if not os.path.exists(img_path):
    #         raise FileNotFoundError(f"render image not found: {img_path}")
