...
| `build_dpo_dataset.py` | Build preference-pair JSONL for DPO training. Generates G rollouts per example, scores with IoU, writes chosen/rejected pairs + reference log-probs. Input: hard-examples pkl or raw STL dir. |
