...
def main():
    ...
    parser.add_argument('--base-model', default='./models/Qwen2-VL-2B-Instruct',
                    help='Local base model path for loading processor')
    ...
    model = Cadrille.from_pretrained(
        ...
        attn_implementation='flash_attention_2', device_map=None).to('cuda')
    model.eval()
